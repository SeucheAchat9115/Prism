"""Atomic ZIP-backed persistence for ``.vibesound`` projects."""
...
from vibesound.project.migrations import DEFAULT_REGISTRY, MigrationRegistry
from vibesound.project.models import CURRENT_SCHEMA_VERSION, AssetReference, Project, new_project
