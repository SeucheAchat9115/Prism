...
from prism.engine import AudioBuffer, ClipSourceProvider, InMemoryClipSourceProvider
from prism.project.models import AssetReference, Project
from prism.project.repository import RepositorySnapshot
from prism.rendering.errors import RenderValidationError
...
def resample_hq(
    ...
    """Apply Prism's anti-aliased SoXR HQ sample-rate conversion policy."""
...
def _prepare_working_project(
    ...
    *,
    ...
    cache_root = snapshot.working_path / ".prism" / "cache" / "audio"
