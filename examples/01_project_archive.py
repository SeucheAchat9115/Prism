"""Create, populate, reload, and validate a self-contained Prism project."""

from __future__ import annotations

from _support import make_archive_fixture, parse_output_dir, print_json

from prism.project import validate_project


def main() -> int:
    run_dir = parse_output_dir(
        "project-archive",
        "Create and validate a ZIP-backed .prism project.",
    )
